...
export default function ProfileScreen() {
  ...
  const { data: student, isLoading, refetch } = useStudent("Z3948428T");
  ...
  const changePhoto = async () => {
    ...
    if (status !== 'granted') return Alert.alert('Error', 'Necesitamos permisos para acceder a tus fotos.');
...
const styles = StyleSheet.create({
  ...
  avatarImg: { width: 90, height: 90, borderRadius: 45, backgroundColor: '#E1E1E1' },
  ...
  cameraIcon: { position: 'absolute', bottom: 0, right: 0, backgroundColor: '#1C1C1E', width: 28, height: 28, borderRadius: 14, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#FFF', elevation: 4 },
  ...
  sectionTitle: { fontSize: 11, color: '#8E8E93', marginLeft: 20, marginTop: 25, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 1 },
  card: { backgroundColor: '#FFF', marginHorizontal: 16, borderRadius: 12, paddingHorizontal: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 2 },
